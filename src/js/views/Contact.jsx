...
const Contact = ({id, name, phone, email, address}) => {
    ...
    return(
        <>
            <img className="rounded-circle mt-4 ms-4" src="https://xsgames.co/randomusers/avatar.php?g=male" style={{width:"150px", height:"150px"}}/>
            <div className="me-5">
            ...
            <div className="modal fade" id={"exampleModal" + id} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary"data-bs-dismiss="modal" onClick={() =>{actions.deleteContact(id)}}>Yes</button>
                    </div>
                    </div>
                </div>
            </div>
